...
class Horodateur {
    ...
    // Déstructeur 
    function __destruct(){
        echo "Au revoir : " . $this->label ."<br><br>";
    }
...
echo $horodateur1->label . " - Futur ? Réponse : " . ($horodateur2->estFutur(1664524330) ? 'Oui' : 'Non') . "<br><br>";
echo $horodateur2->label . " - Différence avec 2074751530 : " . $horodateur2->difference(2074751530) . " secondes<br>";
echo $horodateur1->label . " - Futur ? Réponse : " . ($horodateur2->estFutur(2074751530) ? 'Oui' : 'Non') . "<br><br>";

unset($horodateur1); // destructeur appelé automatiquement (pas besoin de mettre cette ligne)
unset($horodateur2); // destructeur appelé automatiquement (pas besoin de mettre cette ligne)
?>
